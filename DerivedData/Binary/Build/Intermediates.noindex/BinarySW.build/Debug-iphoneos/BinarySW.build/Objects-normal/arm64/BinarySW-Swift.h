...
#ifndef BINARYSW_SWIFT_H
#define BINARYSW_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="BinarySW",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8BinarySW11AppDelegate")
...
SWIFT_CLASS("_TtC8BinarySW13SceneDelegate")
...
SWIFT_CLASS("_TtC8BinarySW18TimeViewController")
@interface TimeViewController : UIViewController
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified label;
@property (nonatomic, strong) IBOutlet UILabel * _Null_unspecified goal;
@property (nonatomic, strong) IBOutlet UILabel * _Null_unspecified result;
@property (nonatomic, strong) IBOutlet UILabel * _Null_unspecified dif;
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified start;
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified pause;
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified reset;
- (IBAction)startButton:(id _Nonnull)sender;
- (IBAction)pauseButton:(id _Nonnull)sender;
...
SWIFT_CLASS("_TtC8BinarySW14ViewController")
@interface ViewController : UIViewController
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified easyButton;
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified difficultButton;
- (void)viewDidLoad;
- (void)prepareForSegue:(UIStoryboardSegue * _Nonnull)segue sender:(id _Nullable)sender;
- (IBAction)levelButtonActionWithSender:(UIButton * _Nonnull)sender;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
